# Ground Truth Benchmark — Path C (containment floor 4→3 chars) — 2026-05-13
...
|------------------------------------|---------|---------|-------|----------------|------------------|
| sample_24_rain_ped_nyc.pdf         | no      | 12      | 14    | 0.8424         | 0.6548           |
...
| sample_full_report.pdf             | yes     | 9       | 15    | 0.8858         | 0.4664           |

## Confidence Calibration

Mean confidence on **correct** extractions:   **0.8449** (n=52)
Mean confidence on **incorrect** extractions: **0.4783** (n=20)
