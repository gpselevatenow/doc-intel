...
function App() {
  ...
  const runExtraction = async () => {
    ...
    for (let i = 0; i < stagedFiles.length; i++) {
      ...
      let endpoint = 'http://127.0.0.1:8003/api/extract/police-report';
      if (item.type === 'ia') {
        endpoint = 'http://127.0.0.1:8003/api/extract/ia-report';
      } else if (item.type === 'acord') {
        endpoint = 'http://127.0.0.1:8003/api/extract/acord-report';
      } else if (item.type === 'hsmv') {
        endpoint = 'http://127.0.0.1:8003/api/extract/hsmv-report';
      }
